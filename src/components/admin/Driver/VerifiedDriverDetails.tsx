  ...
  return (
    <>
            {load ? <SpinnerLoader/>:(
                <>
                    {isStatusModalOpen && (
                <Dialog open={isStatusModalOpen} handler={formik.handleSubmit} className='bg-transparent' placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
...
export default VerifiedDriverDetails
