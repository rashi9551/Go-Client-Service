...
function PendingDetails() {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object({
      reason: yup
        .string()
        .required("Please provide a valide eason !")
        .min(5, "Enter a valid reason"),
    }),
    onSubmit: async (values, { setSubmitting }) => {
      try {
        ...
        if (data.message === "Success") {
          ...
          toast.error("Somethinginternal error");
        }
      } catch (error) {
        toast.error((error as Error).message);
      } finally {
  ...
  return (
    ...
    {load ?<SpinnerLoader/>:(
                  ...
                  <div>
                    <div className="mt-2 text-center">
                      ...
                      <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        Make sure you double checked and validated all the
                        documents submitted by the driver.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-5 sm:flex sm:items-center sm:justify-center">
                    <div className="sm:flex sm:items-center ">
                      ...
                      <button
                        ...
                        className="w-full px-4 py-2 ml-5 mt-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md sm:w-auto sm:mt-0 hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"
                      >
                        VERIFY DRIVER
                      </button>
                    </div>
                ...
                <div className="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl rtl:text-righ  sm:my-8 sm:align-middle sm:max-w-md sm:w-full sm:p-6">
                  <div>
                    <div className="mt-2 text-center">
                      ...
                      <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        Make sure you double checked and validated all the{" "}
                        <br /> documents submitted by the driver.
                      </p>
                    </div>
                  </div>
                  ...
                  <form onSubmit={formik.handleSubmit}>
                    <div className="mt-2 -mx-1 text-center">
                      <h1 className="mx-1 text-sm mt-4 mb-2">
      ...
      <div className="h-screen">
        <h1 className="mx-[7.8rem] mt-10 text-3xl font-bold text-black">
          Driver Details
        </h1>
        <div className="grid md:grid-cols-2 sm:grid-cols-2 gap-4 mt-7 md:px-28 w-full h-full  rounded-3xl">
          <div className=" ml-4 my-4 rounded-3xl px-3 pt-3 pb-4 h-5/6">
            ...
            <div className="w-full md:h-52 h-3/6 bg-white rounded-3xl drop-shadow-2xl ">
              ...
              <div className="md:flex justify-evenly">
                <div className="flex">
                  <button className="btn btn-active btn-neutral btn-xs mx-2">
                    Email
                  </button>
              ...
              <div className="md:flex justify-center items-center h-2/5">
                <button
                  ...
                  className="btn btn-success btn-sm mx-2 bg-green-500 text-white rounded-lg px-4 py-2 shadow-md hover:bg-green-600 transition-all duration-300"
                >
                  Accept
                </button>
                <button
                  onClick={() => setrejectModal(true)}
                  className="btn btn-error btn-sm bg-red-500 text-white rounded-lg px-4 py-2 shadow-md hover:bg-red-600 transition-all duration-300"
                >
                  Reject
                </button>
              </div>
          ...
          <div className=" mx-4 my-4 rounded-3xl px-3 py-4 h-5/6">
            ...
            <div className="w-full h-1/3 bg-amber-200 mt-2 rounded-3xl overflow-hidden drop-shadow-2xl">
              <img
                className="w-full"
                src={driverData?.license.licenseImage}
                alt=""
              />
            </div>
          </div>
        ...
        <div className="w-full h-fit md:flex md:justify-evenly md:px-28 py-10">
          <div className="bg-indigo-400  drop-shadow-2xl w-1/3 h-1/2 rounded-3xl flex flex-col justify-evenly px-5 py-5">
            <div className="">
              <h1 className="text-xl text-white font-bold">
                Vehicle Registeration ID
              </h1>
              <div className="text-center mt-2">
                <h1 className="btn btn-sm btn-neutral">
          ...
          <div className="w-2/4">
            <div className="drop-shadow-2xl h-fit mb-1 rounded-3xl overflow-hidden">
              <img
                className="w-full"
                src={driverData?.vehicle_details.rcImageUrl}
                alt=""
              />
            </div>
